...
public class LogsController {
	...
	public LogDto log(@PathVariable String schoolName,
			@PathVariable Short teacherNo, @RequestParam String year,
			@RequestParam String schoolClassName,
			@RequestParam Short studentNo, @RequestParam String awardType,
			@RequestParam String content) {
		Log log = logManager.insert(schoolName, teacherNo, year, schoolClassName, studentNo, awardType, content);
